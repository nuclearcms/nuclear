{!! field_wrapper_open($options, $name, $errors, 'form-group-node') !!}
...
<div class="form-group-column form-group-column-field">
    ...
    <div class="form-nodes-container">
        <ul class="form-items-list form-items-list-sortable form-items-list-sortable-disabled material-light">
