...
<head>
    ...
    <style type="text/css">
        body{font:16px/20px 'Oxygen',sans-serif;color:#404647;background-color:#F5F5F5;padding:64px;}
        table{max-width:800px;width:100%;background-color:#FAFAFA;border:1px solid #BDC3C7;padding:32px;}
        h1{font:32px/32px 'Oxygen',sans-serif;margin-bottom:16px;}
        h4{color:#BDC3C7;font:12px/14px 'Lato', sans-serif;margin-bottom:0;}
        a{font-size:12px;}
    </style>
</head>
<body>
        ...
        <td class="center" align="center" valign="top">
            <center>
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve" width="48px" height="48px">
                <g>
